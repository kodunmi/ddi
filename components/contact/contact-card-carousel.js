...
const ContactCardCarousel = () => {
  ...
  const {loading  , about, status} = aboutState
        ...
        <Swiper {...swiperOptions}>
          ...
          <SwiperSlide>
            ...
            >
              ...
              <h3>Address</h3>
              <p>
                {loading?'loading':contact.address}
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            ...
            >
              ...
              <h3>Contact</h3>
              <p>
                <a href={`mailto:${loading ? 'loading' : contact.email}`}>{loading ? 'loading' : contact.email}</a> <br/>
